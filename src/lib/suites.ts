...
export const ENDPOINT_SUITES: EndpointSuite[] = [
  {
    ...
    keys: ['stonk-pairs', 'stonk-gems', 'stonk-screener', 'stonk-reward-risk', 'stonk-yield', 'stonk-yield-batch', 'stonk-alerts', 'stonk-quote', 'stonk-launch-intel', 'stonk-launch-preflight'],
  },
  {
    id: 'trenches',
